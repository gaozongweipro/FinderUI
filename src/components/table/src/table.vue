<template>
            ...
            <template #default="scoped">
              ...
              <div v-else class="customCell">
                ...
                <el-dropdown>
                  <el-button  
                      class="tableActionBtn">
                      <svg-icon  style="font-size: 20px; margin-right: 5px"
                      ...
                      <el-dropdown-menu>
                        <template v-for="item in config.actionBtnConfig.btnsConfig" :key="item.key">
                          <template v-if="!item.show"> 
                              ...
                              <el-dropdown-item  v-else  @click.stop="item.click(scoped.row)">{{item.label}}</el-dropdown-item>
                            </template>
                          </template>
                      </el-dropdown-menu>
                    </template>
  ...
  import PaginationAll from "@/components/PaginationAll/index.vue";
